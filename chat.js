...
async function fetchGeminiResponse(prompt) {
    const API_KEY = 'AIzaSyAEksLpxmapRtKyMkwwI5wDyZKCIf7-whI';  // Replace with your actual API key
...
async function sendMessage() {
    ...
    setTimeout(async () => {
        ...
        } else if (message.toLowerCase().includes("arijit singh")) {
            botMessage.textContent = "🎤 Arijit Singh is an **Indian playback singer** known for his soulful voice & hit Bollywood songs. 🎶";
        } else if (message.toLowerCase().includes("arijit singh")) {
            botMessage.textContent = "🎤 Arijit Singh is a leading Indian playback singer known for his soulful voice and diverse musical talent.";
        } 
